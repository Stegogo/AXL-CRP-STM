...
static void adxlInterrupt(ADXL_InitTypeDef * adxl);
...
#ifdef TYPE_FLOAT
float ADXL_acc[3] = {0.0};
float ADXL_accSquare = 0;
float ADXL_accSquareMax = 0;
#else
int32_t ADXL_acc[3] = {0};
uint32_t ADXL_accSquare = 0;
uint32_t ADXL_accSquareMax = 0;
#endif
...
static float GAINX = 0.0f;
static float GAINY = 0.0f;
static float GAINZ = 0.0f;
